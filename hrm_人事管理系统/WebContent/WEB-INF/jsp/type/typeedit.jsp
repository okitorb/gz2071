...
<body>
	<c:set var="type" value="${sessionScope.type }"></c:set>
		...
		<tr valign="top">
			<td>
				...
				<form id="typeForm" name="typeForm"
					action="${ctx }/typeupdate.action" enctype="multipart/form-data"
					method="post">
					<!-- 隐藏表单，flag表示添加标记 -->
					<input type="hidden" name="flag" value="2"> <input
						type="hidden" name="id" value="${type.id }">
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
						class="main_tab">

						<tr>
							<td class="font3 fftd">类型名称：<input type="text" name="name"
								size="30" id="name" value="${type.name }" /></td>
						</tr>
						...
						<tr>
							...
							<select name="state" style="width: 143px;">
									<option value="2">--请选择状态--</option>
									<option value="1">激活使用</option>
						...
						<tr>
							<td class="font3 fftd"><input type="button" id="btn"
								value="确定"> <input type="reset" value="重置"></td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						</tr>
