...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/employeeupdate.action" id="employeeForm" method="post">
			<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">身份证号码：<input type="text" name="card_id" id="card_id" size="20" value="${employee.card_id }"/></td>
		    		</tr>
		    		<tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					QQ&nbsp;&nbsp;号码：<input name="qq_num" id="qq_num" size="20" value="${employee.qq_num }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					邮政编码：<input name="post_code" id="post_code" size="20" value="${employee.post_code }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
