		...
		$("#employeeForm").submit(
				function() {
					...
					if ($.trim(name.val()) == "") {
						...
						msg = "身份证号码不能为空！";
						card_id.focus();
					} else if (!/^[1-9]\d{16}[0-9A-Za-z]$/.test($.trim(card_id
							.val()))) {
						msg = "身份证号码格式不正确！";
						card_id.focus();
...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5"
		...
		<tr valign="top">
			<td>
				<form action="${ctx}/employeeaddsave.action" id="employeeForm"
					method="post">
					<!-- 隐藏表单，flag表示添加标记 -->
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
								...
								<table>
									<tr>
										...
										<td class="font3 fftd">身份证号码：<input type="text"
											name="card_id" id="card_id" size="20" /><span id="cardmsgid"
						...
						<tr>
							<td class="font3 fftd">政治面貌：<input name="party" id="party"
								size="40" />&nbsp;&nbsp; QQ&nbsp;&nbsp;号码：<input name="qq_num"
								id="qq_num" size="20" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="font3 fftd">联系地址：<input name="address"
								...
								name="post_code" id="post_code" size="20" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
