...
<script type="text/javascript">
	...
	function toPage(pageIndex)
	{
	    ...
	    $("#jobform").attr("action", "${ctx}/joblist.action");
		$("#jobform").submit();
	}
 	   ...
 	   $("#delete").click(function(){
 		   ...
 		   if(checkedBoxs.length < 1){
 			   alert("请选择一个需要删除的部门！");
 			    ...
 			    $("#jobform").attr("action", "${ctx}/jobdel.action");
 		 		$("#jobform").submit();
 		   }
 	   })
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">职位名称：<input type="text" name="name"
											value="${job.name}" />&nbsp;&nbsp; <input type="button"
											value="查询" id="query" />&nbsp;&nbsp; <input type="button"
											value="删除" id="delete" />
										</td>
									</tr>
								</table>
						...
						<c:forEach items="${requestScope.joblist}" var="job"
							...
							<tr id="data_${stat.index}" align="center" class="main_trbg"
								...
								<td align="center" width="40px;"><a
									href="${ctx}/viewJob.action?id=${job.id}"> <img
