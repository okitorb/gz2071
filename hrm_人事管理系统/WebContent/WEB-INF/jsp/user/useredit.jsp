...
<form action="${ctx}/userupdate.action" id="userForm" method="post">
    ...
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓&nbsp;名：<input type="text" name="username" id="username" value="${user.username }" size="20"/></td>
		    			<td class="font3 fftd">状&nbsp;态：<input type="text" name="status" id="status" value="${user.status }" size="20"/></td>
		    		</tr>
		    			
		    		<tr>
		    			<td class="font3 fftd">登录名：<input name="loginname" id="loginname" value="${user.loginname }" size="20" /></td>
