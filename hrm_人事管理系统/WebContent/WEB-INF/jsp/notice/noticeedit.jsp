...
<body>
	<c:set var="notice" value="${sessionScope.notice }"></c:set>
		...
		<tr valign="top">
			<td>
				...
				<form id="noticeForm" name="noticeForm"
					action="${ctx }/noticeupdate.action" enctype="multipart/form-data"
					method="post">
					<!-- 隐藏表单，flag表示添加标记 -->
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
						...
						<tr>
							<td class="font3 fftd">公告标题：<input type="text" name="name"
								size="30" id="name" value="${notice.name }" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="font3 fftd">公告描述：<br /> <textarea name="content"
									cols="88" rows="11" id="content" >${notice.content }</textarea>
							</td>
						</tr>
