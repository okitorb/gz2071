...
<html>
	...
	<body>
	<c:set var="document" value="${sessionScope.document }"></c:set>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="${ctx }/documentupdate.action" enctype="multipart/form-data" method="post">
                        <!-- 隐藏表单，flag表示添加标记 -->
