	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${ctx }/documentdel.action?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			id="pageIndex" />
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	标题：<input type="text" name="title" value="${doc.title}"/>
	  ...
	  <tr valign="top">
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${requestScope.documentlist}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${ctx }/viewDocument.action?flag=1&id=${document.id}">
							<img title="修改" src="${ctx }/images/update.gif"/></a>
					  </td>
					  <td align="center"  width="40px;"><a href="${ctx }/documentdownload.action?id=${document.id }" ><!-- <a href="#" id="down_${document.id }"> -->
